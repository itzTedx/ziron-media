				...
				<div className="p-4 md:p-12">
					...
					<MagneticButton className="flex w-fit">
						<Link
							...
							href="/case-studies"
						>
							<div className="group relative z-30 w-fit cursor-pointer overflow-hidden rounded-full border border-primary bg-background p-3 text-center font-semibold text-primary uppercase">
...
const Feature = ({
	...
	return (
		...
		>
			...
			<div className="absolute top-1/2 left-0 h-6 w-1 origin-center -translate-y-1/2 rounded-tr-full rounded-br-full bg-neutral-300 transition-all duration-200 group-hover/feature:bg-primary" />

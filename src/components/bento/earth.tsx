...
export function GlobeDemo() {
  return (
    <div className="relative flex h-screen w-full flex-row items-center justify-center bg-white py-20 dark:bg-black md:h-auto">
      <div className="relative mx-auto h-full w-full overflow-hidden px-4 md:h-[40rem]">
        <motion.div
          initial={{
            opacity: 0,
            y: 20,
          ...
          className="div"
        >
          <h2 className="text-center text-xl font-bold text-black dark:text-white md:text-4xl"></h2>
          <p className="mx-auto mt-2 max-w-md text-center text-base font-normal text-neutral-700 dark:text-neutral-200 md:text-lg"></p>
        </motion.div>

---
  ...
  description: CRM streamlines customer relationships, transforming interactions into insights that drive loyalty and personalized experiences.
...
<AboutCard title="Social Media Management">

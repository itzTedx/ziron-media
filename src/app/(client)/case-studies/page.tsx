						...
						{leftColumnItems.map((item) => (
							<Link className="group" href={item.href} key={item.id}>
								...
								<div className="flex items-center justify-between pt-4">
									...
									<div className="flex shrink-0 items-center justify-center gap-1.5 rounded-lg border bg-background/50 px-4 py-2 font-semibold text-foreground text-sm backdrop-blur-lg transition-all duration-500 ease-out hover:bg-background/800">

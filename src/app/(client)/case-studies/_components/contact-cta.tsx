	...
	return (
		<section className="container max-w-7xl">
			...
			<Link href="/what-we-do">
				<div className="group relative mt-4 w-fit cursor-pointer overflow-hidden rounded-full border border-primary bg-background p-3 text-center font-semibold text-primary uppercase">

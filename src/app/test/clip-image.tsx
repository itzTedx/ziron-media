  ...
  return (
    <>
      ...
      <section className="grid grid-cols-3 gap-8 rounded-lg border bg-white p-5 dark:bg-black">
        <figure className="group rounded-xl bg-gradient-to-b from-[#c9ad66] to-[#bd8122] p-8 transition-all duration-200 hover:p-4">
          <div style={{ clipPath: "url(#clip-goey1)" }}>
            <img
              ...
              alt=""
              className="aspect-square w-full object-cover align-bottom transition-all duration-300 group-hover:scale-110"
            />
          </div>
        </figure>
        <figure className="group rounded-xl bg-gradient-to-t from-[#6f7957] to-[#8c8a57] p-8 transition-all duration-200 hover:p-4">
        ...
        <figure className="group rounded-xl bg-gradient-to-t from-[#d5685a] to-[#ba4344] p-8 transition-all duration-200 hover:p-4">
        ...
        <figure className="group rounded-xl bg-gradient-to-t from-[#f7d578] to-[#9b2a08] p-8 transition-all duration-200 hover:p-4">
        ...
        <figure className="group rounded-xl bg-gradient-to-b from-[#356778] to-[#022641] p-8 transition-all duration-200 hover:p-4">
        ...
        <figure className="group rounded-xl bg-gradient-to-b from-[#89a390] to-[#324644] p-8 transition-all duration-200 hover:p-4">

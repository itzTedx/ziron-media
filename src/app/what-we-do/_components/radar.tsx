    ...
    <div className="relative flex h-96 w-full flex-col items-center justify-center space-y-4 overflow-hidden bg-background px-4">
      <div className="mx-auto w-full max-w-3xl">
        <div className="flex w-full items-center justify-center space-x-8 md:justify-between md:space-x-0">
          <IconContainer
            text="Branding"
            icon={<IconPencilStar className="size-8" stroke={1.75} />}
            delay={0.2}
          />
          <IconContainer
            delay={0.4}
            text="Content Creation"
            icon={<IconDeviceMobile className="size-8" stroke={1.75} />}
          />
          <IconContainer
            text="Web Development"
            delay={0.3}
            icon={<IconBraces className="size-8" stroke={1.75} />}
          />
        </div>
      </div>
      <div className="mx-auto w-full max-w-md">
        <div className="flex w-full items-center justify-center space-x-4 md:justify-between md:space-x-0">
          <IconContainer
            text="SEO"
            delay={0.5}
            icon={<IconChartAreaLine className="size-8" stroke={1.75} />}
          />
          <IconContainer
            text="Lead generation"
            icon={<IconUserSearch className="size-8" stroke={1.75} />}
            delay={0.8}
          />
        </div>
      </div>
      <div className="mx-auto w-full max-w-3xl">
        <div className="flex w-full items-center justify-center space-x-12 md:justify-between md:space-x-0">
          <IconContainer
            ...
            icon={<IconSpeakerphone className="size-8" stroke={1.5} />}
          />
          <IconContainer
            delay={0.7}
            text="UI/UX Design"
            icon={<IconPhotoCode className="size-8" stroke={1.75} />}
          />
        </div>
      </div>
      <h2 className="absolute bottom-6 text-center font-medium max-md:top-0">
